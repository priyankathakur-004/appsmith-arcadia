export default {
	...
	qsTariffs() {
		return this.qs({
			...
			populateProperties: Inp_GetTariffs_populateProperties.selectedOptionValue,
	...
	qsTerritories() {
		return this.qs({
			...
			populateLses: Inp_GetTerritories_populateLses.selectedOptionValue,
	...
	qsProperties() {
		return this.qs({
			...
			excludeGlobal: Inp_GetProperties_excludeGlobal.selectedOptionValue,
